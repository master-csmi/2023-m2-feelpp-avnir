...
image:https://github.com/feelpp/2023-m2-feelpp-sonorhc/workflows/CI/badge.svg[CI]
...
The documentation for 2023-m2-feelpp-sonorhc is available at link:https://feelpp.github.io/2023-m2-feelpp-sonorhc[here] and you can build on it for your project by enabling the link:https://docs.github.com/en/pages[github pages] for your repository.

== Renaming the project

By default the project is named  `2023-m2-feelpp-sonorhc` if you cloned the repository `feelpp/2023-m2-feelpp-sonorhc`.
