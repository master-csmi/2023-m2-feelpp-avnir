...
ifeval::["{project_name}" == "2023 M2 Feelpp Sonorhc"]
[.lead]
{project_name} is a GitHub repository template providing a starting point for {feelpp} projects.
endif::[]
ifeval::["{project_name}" != "2023 M2 Feelpp Sonorhc"]
{project_name} is a {feelpp} project. It was created using the repository template https://github.com/feelpp/2023-m2-feelpp-sonorhc[`feelpp/2023-m2-feelpp-sonorhc`].
endif::[]
